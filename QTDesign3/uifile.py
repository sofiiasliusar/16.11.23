...
"background-color: rgb(255, 76, 238);")
        ...
        self.btn_generate.setGeometry(QtCore.QRect(190, 430, 301, 111))
        font = QtGui.QFont()
        font.setPointSize(28)
...
"border-radius: 16px;")
        ...
        self.resultLineEdit.setGeometry(QtCore.QRect(180, 80, 331, 61))
        font = QtGui.QFont()
        font.setPointSize(28)
        self.resultLineEdit.setFont(font)
        self.resultLineEdit.setStyleSheet("color: rgb(255, 255, 255);")
        self.resultLineEdit.setObjectName("resultLineEdit")
        self.cb_symbols = QtWidgets.QCheckBox(self.centralwidget)
        self.cb_symbols.setGeometry(QtCore.QRect(120, 290, 481, 51))
        font = QtGui.QFont()
        font.setPointSize(28)
        self.cb_symbols.setFont(font)
        self.cb_symbols.setStyleSheet("color: rgb(255, 255, 255);")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.resultLineEdit.setText(_translate("MainWindow", "Тут буде результат"))
        self.cb_symbols.setText(_translate("MainWindow", "Використовувати символи"))
